...
### **Ejercicio 4.1**
   ...
   5. En el `main()` (a) crear 3 personas diferentes (la primera sin nombre) utilizando el constructor primario y secundario y (b) mostrarlas por consola. A continuación, realizar lo siguiente:   
      ...
      * Sobre la persona 2; (a) Modificar la altura para que tenga el mismo valor que la persona 3. (c) Mostrar la persona 2 y persona 3. (b) Comparar si las dos personas son iguales, y mostrar el resultado. 
