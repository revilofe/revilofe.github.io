...
# 2.5. Cómo escribir informes técnicos
...
## 1. Cómo escribir informes técnicos y no morir en el intento
...
#### 1.1.2. Identifica a tu audiencia
...
#### 1.2.2. Define el resto de puntos del informe creando un índice
...
#### 1.2.3. El resumen ejecutivo es tu mejor amigo
...
#### 1.2.4. Los anexos son el trastero de tu informe
...
#### 1.2.5. Haz de tu informe una plantilla
...
#### 1.2.6. Huye de los múltiples niveles anidados.
...
#### 1.2.7. [Advanced] – Convierte tu informe en un recortable
...
#### 1.3.2. Cuidado con las frases largas
...
#### 1.3.3. No escatimes con los párrafos
...
#### 1.3.4. Elige usar voz pasiva o activa
...
#### 1.3.5. Usa los tipos de letra con sabiduría
...
#### 1.3.6. Usa las sangrías para que tu informe se lea mejor
...
#### 1.3.7. Usa la terminología adecuada
...
#### 1.3.8. Los gráficos cuestan, pero merecen la pena
...
#### 1.3.9. [Advanced+] Hazte con un libro de estilo
...
#### 1.4.2. Haz que tus compañeros lean tu informe
...
#### 1.4.3. Lee en voz alta tu informe / Explícaselo a alguien
...
#### 1.4.4. Deshazte de tus coletillas
...
#### 1.4.5. Practica, practica y practica
...
## 2. Cómo escribir informes de incidentes de seguridad
...
#### 2.2.3. Exactitud por encima de todo
...
#### 2.2.4. Cuenta lo que se ha hecho
...
#### 2.2.5. Distingue claramente hechos de hipótesis
...
#### 2.2.6. Data todas tus acciones y genera una *timeline* de eventos
...
#### 2.2.7. Crea un listado de equipos y usuarios afectados
