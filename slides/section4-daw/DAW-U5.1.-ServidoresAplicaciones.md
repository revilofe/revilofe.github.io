...
![Arquitectura](assets/application-server1.webp) <!-- .element height="45%" -->
...
![Capa de control](assets/serv_apl.png) <!-- .element height="45%" -->
...
![Capas](assets/capas.webp) <!-- .element height="45%" -->
...
![Entornos](assets/deploy.png) <!-- .element height="40%" -->
...
![Maven](assets/maven-logo.png) <!-- .element height="35%" -->
...
![Node.js](assets/nodejs-new-pantone-black.svg) <!-- .element height="30%" -->
...
![CI/CD](assets/ci-cd-flow-desktop.png) <!-- .element height="35%" -->
...
![CI](assets/ci.png) <!-- .element height="35%" -->
...
![CD](assets/cd.png) <!-- .element height="35%" -->
...
![Deploy](assets/cd2.png) <!-- .element height="35%" -->
